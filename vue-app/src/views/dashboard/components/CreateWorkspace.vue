...
<template>
  <ModalForm
    ...
    :show="useWorkspace.modals.create"
    @close="closeModal"
  >
    <form @submit="createWorkspace" @keydown.enter.prevent="createWorkspace">
      ...
      <div class="messageModal_footer__EhWT8">
        ...
        <PrimaryButton :disabled :submitting>Create</PrimaryButton>
      </div>
    </form>
  </ModalForm>
</template>
