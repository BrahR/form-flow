...
<template>
  <div class="sharedBuild_toggle_input_row_wrapper sharedBuild_ltr">
    <div class="appreciation_auto_reload_wrapper">
      <div class="appreciation_toggle_wrapper">
        <div class="toggleButton_wrapper undefined false">
          <span class="toggleButton_title toggleButton_bold">Auto Reload</span>
...
.appreciation_auto_reload_wrapper {
  width: 100%;
  display: flex;
...
.appreciation_auto_reload_wrapper .appreciation_toggle_wrapper {
  height: 1.25rem;
}
</style>
