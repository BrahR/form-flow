...
<template>
  <div class="sharedBuild_toggle_input_row_wrapper sharedBuild_ltr">
    <div class="appreciation_link_button_wrapper">
...
.appreciation_link_button_wrapper {
  display: flex;
  flex-direction: column;
  justify-content: stretch;
  font-size: 14px;
}
.appreciation_link_button_wrapper .appreciation_toggle_wrapper {
  min-height: 1.25rem;
}
</style>
