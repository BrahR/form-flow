...
const { randomizeGroup } = storeToRefs(useQuestionToggles);
...
randomizeGroup.value.selected = options[0];
</script>
    ...
    <div class="group_toggle_component_wrapper__S7tie">
      <div class="sharedBuild_toggle_wrapper__R5w_y">
        ...
        <template v-if="randomizeGroup.on">
          ...
          <div
            v-if="randomizeGroup.selected.id === 2"
            ...
            <div class="inlineInput_wrapper__7HOFO inlineInput_ltr__IdP5R">
              ...
              <div class="inlineInput_input_wrapper__8ZUU7">
                <input
                  ...
                  type="number"
                  min="1"
                  v-model="randomizeGroup.selected.value"
                />
              </div>
              <InputError
                v-if="
                  !randomizeGroup.selected.value ||
                  randomizeGroup.selected.value < 0
                "
