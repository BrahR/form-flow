...
<template>
  <div class="preview_multiplechoice_question_wrapper__RatfO preview_ltr__Yc2N7" style="opacity: 1">
    <div class="questionIntro_question_intro_wrapper__93qE0">
      <div class="questionIntro_question_intro_title__soL_1">
        <div class="questionIntro_question_intro_title_text_wrapper__FjDMC">
          <div class="questionIntro_question_number_wrapper__4lzy7">
            ...
            >*</span>
            <span v-if="!useQuestion.getHideQuestionNumber.on"
                  class="questionIntro_question_number___M7ip">1</span>
            <div v-if="!useQuestion.getHideQuestionNumber.on"
          ...
          <span class="questionIntro_question_intro_title_text__YurZo"
                v-html="useQuestion.getLabel"></span>
        </div>
      </div>
      <p
      ...
      <p class="questionIntro_question_intro_porsline_description__ZEPzQ">
        {{ useQuestion.getMultipleAnswersText }}</p>
    </div>

    <div :class="{ 'flex-col' : useQuestion.getVerticalDisplay.on }"
      ...
      <template v-for="(choice, index) in useQuestion.getChoices" :key="index">
        ...
        >
          <div class="preview_question_number_and_label_wrapper__Bj0ev">
            <div><p class="preview_question_number__VUiY4 preview_ltr__Yc2N7">{{ index + 1 }}</p></div>
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                <g fill="none" fill-rule="evenodd">
                  <g>
                    ...
                    <path fill="#5A5E66" fill-rule="nonzero"
                          d="M20.7 7.7l-11 11c-.2.2-.4.3-.7.3-.3 0-.5-.1-.7-.3l-5-5c-.4-.4-.4-1 0-1.4.4-.4 1-.4 1.4 0L9 16.6 19.3 6.3c.4-.4 1-.4 1.4 0 .4.4.4 1 0 1.4z"></path>
                  </g>
                </g>
              </svg>
            </div>
...
.questionIntro_question_intro_wrapper__93qE0 .questionIntro_question_intro_porsline_description__ZEPzQ {
  padding-top: 1.23em;
  font-size: .8125em;
...
.preview_multiplechoice_question_wrapper__RatfO .preview_multiplechoice_question_choices_wrapper__9pZyU .preview_multichoice_item__im8xB .preview_selected_choice_icon_wrapper__7VOl3 .preview_selected_choice__fQxbn {
  padding-top: 0;
  height: 1.75rem;
  min-width: 1.75rem;
  font-size: 1em;
...
.preview_multiplechoice_question_wrapper__RatfO .preview_multiplechoice_question_choices_wrapper__9pZyU .preview_multichoice_item__im8xB .preview_selected_choice_icon_wrapper__7VOl3 .preview_selected_choice__fQxbn svg path:last-child {
  fill: var(--preview-theme-accent-color-contrast);
}

.preview_multiplechoice_question_wrapper__RatfO .preview_multiplechoice_question_choices_wrapper__9pZyU .preview_multichoice_item__im8xB.preview_selected_choice__fQxbn {
  border-color: var(--preview-theme-accent-color);
  box-shadow: 0 0 0 0.1875rem var(--preview-theme-accent-color);
  background-color: transparent;
}

.buildChoice_input_wrapper__j2HKG.buildChoice_hidden__ITdK4 {
  opacity: .7;
}
...
.questionIntro_question_intro_wrapper__93qE0 .questionIntro_question_intro_description__J0fpU {
  text-align: start;
...
.questionIntro_question_intro_wrapper__93qE0 .questionIntro_question_intro_title__soL_1 .questionIntro_question_intro_title_text_wrapper__FjDMC .questionIntro_answer_required_icon__xsNa1 {
...
.questionIntro_question_intro_wrapper__93qE0 .questionIntro_question_intro_title__soL_1 .questionIntro_question_intro_title_text_wrapper__FjDMC .questionIntro_answer_required_icon__xsNa1.questionIntro_ltr__PbYmc {
  margin-right: 0;
  margin-left: -.563rem;
}
