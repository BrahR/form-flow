...
<template>
  <div
    class="questionNumber_question_number_wrapper__eCXI_ questionNumber_welcome__AtnYQ questionNumber_without_number__wzBhB questionNumber_ltr__n8kqK"
  >
...
.questionNumber_question_number_wrapper__eCXI_
  .questionNumber_question_number_text__MJfAs {
  margin: 0 0.125rem;
}
