...
<template>
  <div class="ptr">
    ...
    <div class="ptr__children">
      <div class="main_main_design_wrapper__ksIzq">
        <div class="designSidebar_scroll_wrapper__hcjHd">
        ...
        <div class="main_preview_wrapper__sqq83">
          <div class="preview_preview_wrapper__MPnYX">
            <div class="preview_preview_button_group__WiDBJ">
              <button class="preview_fullscreen__3KfIc false" type="button">
...
.designNavbar_design_navbar_wrapper_desktop__zideH {
  display: block;
  width: 21.25rem;
  height: 2rem;
}

.designNavbar_design_navbar_wrapper_desktop__zideH button {
  height: 2rem !important;
}

.designNavbar_design_navbar_wrapper_tablet_mobile__MTm41 {
  display: none;
}
...
.preview_preview_button_group__WiDBJ button {
  background-color: #fff;
  width: 2rem;
  height: 2rem;
  padding: 0.25rem;
...
.preview_preview_button_group__WiDBJ button .preview_svg_on__noczb svg g g {
  stroke: #3b368e;
}
...
.preview_preview_button_group__WiDBJ button:focus {
  outline: none;
}
...
.preview_iframe_container__4tQE5 iframe {
  width: 100%;
  height: 100%;
  border: none;
  border-radius: 0.25rem;
...
.preview_preview_wrapper__MPnYX {
  width: 100%;
  height: 100%;
  display: flex;
...
.moreDropDown_wrapper__3ZqgO .moreDropDown_button__3GhWA {
  background-color: #fff;
  width: 2rem;
  min-height: 1.5rem;
...
.themesSidebar_main_wrapper__LefOi .themesSidebar_public_themes_wrapper__FVHHK {
  margin-bottom: 3rem;
}
...
.main_main_design_wrapper__ksIzq {
  display: flex;
  flex-direction: row;
  height: 100%;
}

.main_preview_wrapper__sqq83 {
  width: 100%;
}
